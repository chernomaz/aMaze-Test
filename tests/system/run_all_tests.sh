...
# Update PYTHON to the Python interpreter inside your virtual environment.
# Can also be overridden at the command line: PYTHON=/my/venv/bin/python ./run_all_tests.sh
PYTHON="${PYTHON:-/home/ubuntu/venv/bin/python}"
export PYTHON

# Make the amaze package importable even if not installed in the venv.
