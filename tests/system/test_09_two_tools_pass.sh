...
cd "$PROJECT_ROOT"
export AGENT_PROMPT="get the bitcoin price today and if it bigger then 10  check Alice's email"
"$PYTHON" -m amaze.amaze_runner examples/agents/one_conversation_agent.py examples/policies/two_tools_policy.json
